  ...
  MISSIONS = {
    ...
    INSUFFICIENT_AP = {
      ...
      CONSUMED_STILL_INSUFFICIENT = {
        COLORS = {
          compat = true,
          {x = 600, y = 554, color = 11765316},
          {x = 700, y = 554, color = 11765316},
          {x = 800, y = 554, color = 11765316},
          {x = 900, y = 554, color = 11765316},
          {x = 1000, y = 554, color = 11765316},
          {x = 1100, y = 554, color = 11765316},
          {x = 1200, y = 554, color = 11765316},
          {x = 1300, y = 554, color = 11765316},
          {x = 1400, y = 554, color = 11765316},
          {x = 938, y = 931, color = 11070207},
          {x = 988, y = 931, color = 11069695},
          {x = 998, y = 931, color = 11202303},
          {x = 1008, y = 931, color = 11003903},
          {x = 1038, y = 931, color = 11202303},
          {x = 1078, y = 931, color = 11003903},
          {x = 1088, y = 931, color = 11003903},
          {x = 1108, y = 931, color = 11003903},
          {x = 1128, y = 931, color = 11003903}
        },
      ...
      FINAL = {
        IPAD_AIR = {
          COLORS = {
            ...
            {x = 118, y = 1141, color = 16711422},
            {x = 130, y = 1141, color = 16711422},
            {x = 148, y = 1141, color = 16711422},
            {x = 190, y = 1141, color = 16711422},
            {x = 212, y = 1141, color = 16711422},
            {x = 242, y = 1141, color = 16711422},
            {x = 252, y = 1141, color = 16382457},
            {x = 258, y = 1141, color = 16711422},
        ...
        IPAD_2017 = {
          COLORS = {
            ...
            {x = 118, y = 1141, color = 16777215},
            {x = 130, y = 1141, color = 16777215},
            {x = 148, y = 1141, color = 16777215},
            {x = 190, y = 1141, color = 16777215},
            {x = 212, y = 1141, color = 16777215},
            {x = 242, y = 1141, color = 16777215},
            {x = 252, y = 1141, color = 16382457},
            {x = 258, y = 1141, color = 16777215},
            {x = 278, y = 1141, color = 16777215},
            {x = 292, y = 1141, color = 16777215},
